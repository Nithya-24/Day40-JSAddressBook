...
/**
 * to Delete the  Contact From Address Book
 */
...
/**
 * to Count Total Number Of Contact 
 */
...
/**
 * to Count Contact From Perticuler City Or State
 */
...
function selectFunction(select){
    switch(select){
        case "contactDetails":
                 ...
                 */
                contactDetails("Nithya","Ram","Kurukupathai","Sivakasi","TamilNadu","626130","nith@gmail.com","91 7894561320");
                contactDetails("Selva","Asir","Pandiyan","Virudhunagar","Kerala","465210","selva@gmail.com","91 725647105");
                ...
                */
                ...
                contactDetails("jeba","Raj","Pandiyan","Virudhunagar","KN","789456","jebs@gmail.com","91 1234567891");
        ...
        case "editContact":
                ...
                */
                editContact("Nithya","city","Sivakasi");
                console.log(addressBook);
                break;
        case "deleteContact":
                /*
        ...
        case "searchByCity_State":
                /*
                * Search Function To Search Contact in Address Book
                */
                searchByCity_State("state","TamilNadu");
                break;
        case "viewByCityOrState":
                /*
                * View By State or City Function
                */
                viewByCityOrState("state","Kerala");
                break;
        case "countContactInCity_State":
                /*
                * Count by City And State Function
                */
                countContactInCity_State("state","TamilNadu");
                countContactInCity_State("city","Sivakasi");
                break;
        case "sortContact":
                /*
                * Sort Function
